...
from core.views import PinViewSet, ImageViewSet, BoardViewSet, TagAutoCompleteViewSet,\
    BoardAutoCompleteViewSet, HotTagViewSet
...
drf_router.register(r'hot_tags', HotTagViewSet)
